...
<section class="panel" style="padding: 25px;">
    ...
    <div class="panel">
        <div class="panel-header">
            <div class="panel-title"><i class="fas fa-cloud-upload-alt"></i> Add Accomplishment</div>
...
<div class="paar-confirm-overlay" id="paarConfirmModal" aria-hidden="true">
    <div class="paar-confirm-modal" role="dialog" aria-modal="true" aria-labelledby="paarConfirmTitle">
        <div class="paar-confirm-head">
            ...
            <span id="paarConfirmTitle">Complete accomplishment?</span>
        </div>
        <div class="paar-confirm-body">
            This will save the PAAR documents and mark the activity as completed.
        </div>
