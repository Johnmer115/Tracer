...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('css/form.css') }}">
        <div class="form-panel">
            ...
            @endif
            <div class="form-body">
                <form action="{{ route('dean_osa.account.store') }}" method="POST">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control searchable-select" id="usertype" name="usertype" required>
                                <option value="Dean_OSA" @selected(old('usertype') === 'Dean_OSA')>Dean OSA</option>
                                <option value="Staff_OSA" @selected(old('usertype') === 'Staff_OSA')>Staff OSA</option>
                                <option value="Branch_OSA" @selected(old('usertype') === 'Branch_OSA')>Branch OSA</option>
                            </select>
                        </div>

                        {{-- Branch fields — only visible when usertype = branch_osa --}}
                        <div id="org-fields" style="{{ old('usertype') === 'Branch_OSA' ? '' : 'display:none;' }}">
