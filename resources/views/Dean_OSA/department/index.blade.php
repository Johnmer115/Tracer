                                    ...
                                    <td>
                                        <div class="action-cell">
                                            ...
                                            <form action="{{ route('dean_osa.department.destroy', $department->id) }}" 
                                                ...
                                                <button type="button" class="abtn abtn-del" title="Delete Department"
...
<div class="del-overlay" id="deleteModal" aria-hidden="true" onclick="closeDeleteModal()">
    <div class="del-modal" role="dialog" aria-modal="true" aria-labelledby="deleteTitle" onclick="event.stopPropagation()">
        <div class="del-head">
            <i class="fas fa-trash-alt"></i>
            <span id="deleteTitle">Delete department?</span>
        </div>
        <div class="del-body">
            <p style="margin:0;">This action cannot be undone.</p>
            <div class="del-name" id="deleteName">Department Name</div>
            <div class="del-warning">
                <i class="fas fa-exclamation-triangle" style="margin-top:2px;"></i>
                <span>Deleting this department will permanently delete all organizations and activities registered under it.</span>
            </div>
        </div>
...
<script>
    ...
    function openDeleteModal(button) {
        ...
        if (name) name.textContent = button.dataset.deleteName || 'Selected department';
        if (modal) {
