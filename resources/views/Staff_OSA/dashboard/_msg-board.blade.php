{{-- ══════════════════════════════════════════════
     ...
     Usage: @include('Staff_OSA.dashboard._msg-board', ['canCompose' => true/false])
══════════════════════════════════════════════ --}}
                    ...
                    <div class="msg-footer">
                        ...
                        @if($canCompose)
                            <div class="msg-actions">
                                <form action="{{ route('staff_osa.messages.pin', $msg->id) }}" method="POST" style="display:inline;">
                                    @csrf @method('PATCH')
                                ...
                                <form action="{{ route('staff_osa.messages.delete', $msg->id) }}" method="POST" style="display:inline;"
